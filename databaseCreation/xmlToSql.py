...
def randomly_attribute(attribute):
    ...
    patronus = ['Phénix','Dragon','Hippogriffe','Hibou','Licorne','Veracrasse','Niffleur','Fléreur','Crabe de Feu','Boursouf','Chimère','Hippocampe','Chat','Chien','Kappa','Nundu','Limace à cornes','Bison','Grenouille lunaire','Vache','Mouette','Antilope','Canard','Iguane','Snallygaster','Puckwoodgenie','Baleine','Étoile de mer', 'Âne','Grinchebourdon','Serpencendre (ashwinder)','Tranchesac ongubulaire','Tébo','Tigre à dents de sabre','Girafe','Chrysope']
